...
Nous y trouvons les commandes d'ouvertes des transistors qui seront transmises aux drivers.
...
Cet adoucissement est un effet volontaire introduit avant l'entrée des commandes dans le drivers MOS.
