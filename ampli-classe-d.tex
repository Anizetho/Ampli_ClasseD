...
\begin{gather}
    ...
    \begin{cases}
        d_{t} = \frac{1}{2 \cdot frequence} = \frac{1}{2 \cdot 170.000} = \SI{2.94}
            {\micro\second} \\
        d_{V_0}= \SI{2}{\volt}  
    \end{cases}
    ...
    \intertext{Finalement, nous pouvons présenter l'allure dans un graphique de la tension
               ...
               théorique établie à la section~\ref{subsec:sigma_delta} pour un intégrateur
               pur, soit :} 
